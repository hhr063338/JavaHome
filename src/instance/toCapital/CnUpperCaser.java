...
public class CnUpperCaser {
  ...
  private static final char[] fls={'角','分'};
  ...
  public String getCnString(){
    ...
    for(int i=0;i<integerPart.length();i++){
      ...
      sb.append(series[integerPart.length()-1-i]);
    	  ...
    	  if(getNumber(integerPart.charAt(i-1))==0){
...
//	   */
  public static void main(String[] args) {
    System.out.println(new CnUpperCaser("123456789.12").getCnString());
//	    System.out.println(new CnUpperCaser("123456789").getCnString());
//	    System.out.println(new CnUpperCaser("0").getCnString());
